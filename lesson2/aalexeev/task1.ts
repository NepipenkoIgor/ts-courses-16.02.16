...
console.log(summator<number>(1, 1, 2, 3, 5, 8, 13));
console.log(summator<string>("Эйяфьятлайокудль ", "эйяфьятлайокудляли, ", "эйяфьятлайокудляли,  ", "но ", "не ", "выэйяфьятлайокудляли. ", "\n", "Надо ", "эйяфьятлайокудль ", "переэйяфьятлайокудлевать ", "да ", "перевыэйяфьятлайокудлевать. "));
